(function() {
  ...
  _.map = function(collection, iterator) {
    ...
    // like each(), but in addition to running the operation on9all
  ...
  _.every = function(collection, iterator) {
    ...
    return _.reduce(collection, function(prevMatch, item){
      if(iterator === undefined){
        return item
      }
      return prevMatch && !!iterator(item)
    }, true);
  };
  ...
  _.delay = function(func, wait) {
    ...
    setTimeout(function(){func.apply(this, passedArgs)}, wait)
    };
